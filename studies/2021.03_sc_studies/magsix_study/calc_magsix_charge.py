...
tray.AddSegment(hdfwriter.I3HDFWriter, 'hdf', 
	...
	Keys=['I3EventHeader', 'HomogenizedQTot', 'HomogenziedQtot_SplitInIcePulses', 'HomogenizedQTot_DeepMagSix',
	'EHEPortiaEventSummarySRT', 'PortiaEventSummarySRT_DeepMagSix'], 
	SubEventStreams=['InIceSplit']
	)
