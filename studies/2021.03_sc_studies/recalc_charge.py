...
pulse_name='SplitInIcePulses' # use *Split*InIcePulses
...
tray.AddModule('HomogenizedQTot', 'qtot_total_caliberr',
	Pulses=pulse_name,
	Output='HomogenziedQtot_SplitInIcePulses_ExcludeCalibrationErrata',
	ExcludeTimeWindows=True,
	TimeWindowsToExclude=['CalibrationErrata']
	)


tray.AddSegment(hdfwriter.I3HDFWriter, 'hdf', 
	Output="{}/y{}_c{}_f{}_hqtot_splitinnicepulses.hdf5".format(args.output_dir, args.year, args.candle, args.filter_setting), 
	Keys=['I3EventHeader', 'HomogenizedQTot', 'HomogenziedQtot_SplitInIcePulses', 
	'HomogenziedQtot_SplitInIcePulses_ExcludeCalibrationErrata', 'EHEPortiaEventSummarySRT'], 
