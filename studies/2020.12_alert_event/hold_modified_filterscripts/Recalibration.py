...
def InIceCalibration(tray, name, InputLaunches='CleanInIceRawData',
    ...
    # tray.AddModule('I3WaveformSplitter', name+'/WaveformSplitter',                                                                                                                                                                                                            
    #     Input='CalibratedWaveforms', HLC_ATWD='CalibratedWaveforms_ATWD',                                                                                                                                                                                                     
    #     HLC_FADC='CalibratedWaveforms_FADC', SLC='CalibratedWaveforms_SLC')                                                                                                                                                                                                   
    # tray.AddModule('I3Wavedeform', name + '/wavedeform',                                                                                                                                                                                                                      
    #     ApplySPECorrections = WavedeformSPECorrections,                                                                                                                                                                                                                       
    #     Waveforms='CalibratedWaveforms_FADC',                                                                                                                                                                                                                                 
    #     Output=OutputPulses) 
    ...
    #     Keys=['CalibratedWaveforms', 'CalibratedWaveforms_ATWD',
