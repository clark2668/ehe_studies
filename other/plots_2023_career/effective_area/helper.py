...
#     comp_dict_jm['file_list'] = [
#         [os.path.join(DATA_PATH, 'mu_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jm['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#                                       ],
#                                       'Additional observables.']
#     comp_dict_jm['n_files_total'] = [2000, 'Number of files in Madison.']
#     comp_dict_jm['n_files_loaded'] = [[1000], 'Number of files loaded.']
...
#     comp_dict_jmv['file_list'] = [
#         [os.path.join(DATA_PATH, 'mu_very_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jmv['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#     comp_dict_jt['file_list'] = [
#         [os.path.join(DATA_PATH, 'tau_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jt['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#                                        'EHEMuMillipede_SplineMPEseed_500m_depE.value',],
#                                       'Additional observables.']
#     comp_dict_jt['n_files_total'] = [2000, 'Number of files in Madison.']
#     comp_dict_jt['n_files_loaded'] = [[1000], 'Number of files loaded.']
...
#     comp_dict_jtv['file_list'] = [
#         [os.path.join(DATA_PATH, 'tau_very_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jtv['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#     comp_dict_jnt['file_list'] = [
#         [os.path.join(DATA_PATH, 'nutau_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jnt['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#                                        'EHEMuMillipede_SplineMPEseed_500m_depE.value',],
#                                       'Additional observables.']
#     comp_dict_jnt['n_files_total'] = [2000, 'Number of files in Madison.']
#     comp_dict_jnt['n_files_loaded'] = [[1000], 'Number of files loaded.']
...
#     comp_dict_jntv['file_list'] = [
#         [os.path.join(DATA_PATH, 'nutau_very_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jntv['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#     comp_dict_jne['file_list'] = [
#         [os.path.join(DATA_PATH, 'nue_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jne['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#                                        'EHEMuMillipede_SplineMPEseed_500m_depE.value',],
#                                       'Additional observables.']
#     comp_dict_jne['n_files_total'] = [2000, 'Number of files in Madison.']
#     comp_dict_jne['n_files_loaded'] = [[1000], 'Number of files loaded.']
...
#     comp_dict_jnev['file_list'] = [
#         [os.path.join(DATA_PATH, 'nue_very_high_energy_merged_1kfiles.hdf5')],
#         'Files for the component.']
#     comp_dict_jnev['flux_names'] = [
#         j_flux_names,
#         'Weight cols.']
...
#                      comp_dict_jnev, to_log=False)
    ...
    comp_dict_mu['n_files_loaded'] = [
        [9981.2, 9981.2,
         1000., 999., 998., 998., 998., 1000., 1000., 1000., 1000., 999.,
         998., 1000., 997., 995., 999., 999., 997., 996., 992., 996.,
         982., 989., 987., 986., 987., 986., 981., 982., 982., 979.],
